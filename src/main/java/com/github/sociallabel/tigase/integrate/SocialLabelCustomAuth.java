...
public class SocialLabelCustomAuth extends TigaseCustomAuth {

	/**
	 * Private logger for class instances.
	 */
	private static final Logger log = Logger.getLogger(SocialLabelCustomAuth.class.getName());
	...
	private String web_config_url = DataUtil.WEB_SERVER_ADDRESS;
	...
	public void initRepository(final String connection_str, Map<String, String> params)
		...
		try {
			String url = System.getProperty("web-config-url");
	...
	public boolean plainAuth(BareJID user, final String password)
		...
		boolean result = internalLogin(user.toString(), password);
		if (result) {
			try {
				getPassword(user);
	...
	private boolean internalLogin(String user, String password){
